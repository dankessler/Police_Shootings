...
fitKilling <- stan(file='/home/kesslerd/repos/Analysis/PoliceShootings/Covariates.stan', data = model_dat, thin=1, iter = iter, warmup=warmup,chains = 1,refresh=10,pars=c("Theta","Sigma"))
